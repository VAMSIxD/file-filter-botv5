...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            ...
            [
                InlineKeyboardButton('♻️ Updates Channel ♻️', url='https://t.me/PVTSERVER')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('☎️CONTACT ME', url='https://t.me/Dextergrey'),
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHANNEL 💠', url='https://t.me/+ady-WM2357g1ODg1'),
            InlineKeyboardButton('☎️ CONTACT ME', url='https://t.me/Dextergrey'),
            InlineKeyboardButton('💠 UPDATES 💠', url='https://t.me/Pvtserver')
            ],[
